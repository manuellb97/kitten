...
2.2. Requisitos funcionales. <br/>
	...
	5. El juego contará con varios niveles, los cuales se irán superando al llegar a la puntuación necesaria.
	6. Cada dos niveles la velocidad de la serpiente incrementará. ¿bonus?
	7. Se generará una fruta en una posición aleatoria del mapa.
	8. Habrá varios tipos de fruta, no solo una.
	9. Acerca del movimiento de la serpiente tendremos varios requisitos funcionales: 
